...
int main()
{
    ...
    // A primeira estrutura de repetição será o for para a peça Torre, essa peça tem que mover 5 vezes para a direita.
    ...
    // Próxima peça é o Bispo com o uso do while para os movimentos, o Bispo deverá se mover 5 vez na diagonal para cima e direita.
    // Os eixos são usados para o usuário saber que a peça está se movendo diagonalmente, mas ainda fazendo o movimento simples de ir pra cima e pra a direita.
